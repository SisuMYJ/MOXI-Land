...
const assetVersion = 'portrait-baseland-animal-garden-20260627-02';
...
export const visualAssets: Record<string, VisualAsset> = {
  ...
  'animal-garden': usable({ key: 'animal-garden', path: generatedUrl('animal%20garden.png'), scale: 1, origin: [0.5, 1], labelOffset: [0, 14], footprint: { w: 126, h: 112 }, depthRule: 'y' }),
