...
export const visualAssets: Record<string, VisualAsset> = {
  ...
  'task-cottage': usable({ key: 'task-cottage', path: generatedUrl('task-cottage.png'), scale: 1, origin: [0.24, 1], labelOffset: [30, 18], footprint: { w: 112, h: 111 }, depthRule: 'y' }),
  ...
  'lantern-shop': usable({ key: 'lantern-shop', path: generatedUrl('lantern-shop.png'), scale: 1, origin: [0.5, 1.24], labelOffset: [0, -10], footprint: { w: 118, h: 131 }, depthRule: 'y' }),
